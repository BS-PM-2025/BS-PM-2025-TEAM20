...
# View to render the lecturer's page (Currently renders secretary page by mistake)
def lec_page(request):
    return render(request, 'sec_page.html')  # ⚠️ Note: It should probably be 'lec_page.html' instead of 'sec_page.html'


# View to handle login for a special lecturer account
